-- E-imza sayfalarinin govdeleri yeniden cikarilip temizlenir.
--
-- V18 cikarmasi kucuk sayfalarda, icerik kabina ait olmayan fazladan
-- </div> ve <div class="temizle"> kalintilarini da almisti; dengesiz div
-- yapisi bu sayfalarin duzenini bozuyordu (icerik bos/kirik goruonuyordu).
-- Cikarici div-derinligi dengeleyecek sekilde duzeltildi; icerik birebir
-- ayni, yalniz kaba ait olmayan kalintilar atildi.

UPDATE page SET content_html = $eimza$<div class="icerik">
...
<hr>
</div>$eimza$, updated_at = now()
WHERE slug = $eimza$e-signature$eimza$ AND language = $eimza$tr$eimza$;
...
WHERE slug = $eimza$e-signature-about$eimza$ AND language = $eimza$tr$eimza$;
...
WHERE slug = $eimza$e-signature-legislation$eimza$ AND language = $eimza$tr$eimza$;
...
WHERE slug = $eimza$e-signature-application$eimza$ AND language = $eimza$tr$eimza$;

UPDATE page SET content_html = $eimza$<div class="icerik">
<img src="https://bidb.hacettepe.edu.tr/eimza/images/isakisi_20141120_personel.jpg" width="623" height="860" border="0">
</div>$eimza$, updated_at = now()
WHERE slug = $eimza$e-signature-workflow$eimza$ AND language = $eimza$tr$eimza$;
...
WHERE slug = $eimza$e-signature-certificate-received$eimza$ AND language = $eimza$tr$eimza$;
...
WHERE slug = $eimza$e-signature-java$eimza$ AND language = $eimza$tr$eimza$;
...
WHERE slug = $eimza$e-signature-remote-desktop$eimza$ AND language = $eimza$tr$eimza$;
...
WHERE slug = $eimza$e-signature-security-word$eimza$ AND language = $eimza$tr$eimza$;
...
WHERE slug = $eimza$e-signature-renewal$eimza$ AND language = $eimza$tr$eimza$;
...
WHERE slug = $eimza$e-signature-update$eimza$ AND language = $eimza$tr$eimza$;
...
WHERE slug = $eimza$e-signature-cancellation$eimza$ AND language = $eimza$tr$eimza$;
...
WHERE slug = $eimza$e-signature-info-update$eimza$ AND language = $eimza$tr$eimza$;
...
WHERE slug = $eimza$e-signature-password$eimza$ AND language = $eimza$tr$eimza$;
...
WHERE slug = $eimza$e-signature-unit-officers$eimza$ AND language = $eimza$tr$eimza$;
...
WHERE slug = $eimza$e-signature-faq$eimza$ AND language = $eimza$tr$eimza$;

-- Satir-ici gorseller yerelde (V19 ile ayni donusum; yeniden yazim guvenli).
UPDATE page SET content_html = replace(content_html, $eimza$https://bidb.hacettepe.edu.tr/eimza/images/$eimza$, $eimza$/images/eimza/$eimza$)
WHERE slug LIKE $eimza$e-signature%$eimza$ AND language = $eimza$tr$eimza$;
