...
import tr.edu.hacettepe.bidb.repo.YuklenenDosyaRepo;
...
public class YonetimDosyaController {
    ...
    private final YuklenenDosyaRepo kayitlar;
    private final Path dizin;

    public YonetimDosyaController(YuklenenDosyaRepo kayitlar,
    ...
    @GetMapping
    public List<YuklenenDosya> liste() {
    ...
    public ResponseEntity<?> yukle(@RequestParam("dosya") MultipartFile dosya, Authentication kimlik) {
        ...
        YuklenenDosya kayit = new YuklenenDosya();
