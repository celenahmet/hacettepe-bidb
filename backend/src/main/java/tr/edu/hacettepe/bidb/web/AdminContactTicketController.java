...
public class AdminContactTicketController {
    ...
    public record TicketView(Long id, String referenceCode, String language, String category,
        String subject, String requesterFirstName, String requesterLastName, String requesterEmail,
        String requesterPhone, String message, String status, String priority, String assignedTo,
        String adminNote, String attachmentUrl, String attachmentName, Long attachmentSizeBytes,
        ...
        static TicketView of(ContactTicket ticket) {
            return new TicketView(ticket.getId(), ticket.getReferenceCode(), ticket.getLanguage(),
                ticket.getCategory(), ticket.getSubject(), ticket.getRequesterFirstName(),
                ticket.getRequesterLastName(), ticket.getRequesterEmail(), ticket.getRequesterPhone(),
                ticket.getMessage(), ticket.getStatus(), ticket.getPriority(), ticket.getAssignedTo(),
                ticket.getAdminNote(), ticket.getAttachmentUrl(), ticket.getAttachmentName(),
                ticket.getAttachmentSizeBytes(), ticket.getCreatedAt(), ticket.getUpdatedAt(), ticket.getResolvedAt());
        }
    }
